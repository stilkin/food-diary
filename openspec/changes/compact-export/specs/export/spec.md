...
- **AND** notes (if any) SHALL render on a separate line below the header
...
- **THEN** the header SHALL render as `11:08 — Food` and the notes SHALL appear on a separate line below
...
- **THEN** the image SHALL be rendered as a 100×100px square
...
- **THEN** it SHALL render as a 100×100px square, cropped from center
